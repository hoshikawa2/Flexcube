...
#
    ...
    sed -i "s~--JDBDString-- --JDBCPassword--~$JDBCString $JDBCPassword~g" integrated144-devops.yaml > integrated144-devops-exec.yaml
    # Deploy integrated144
    kubectl config view
    kubectl get nodes
    kubectl replace -f integrated144-devops-exec.yaml --force
